  ...
  var template = 
    ...
    var clickHandler = function(event) {
      ...
      if (currentlyPlayingSong !== null) {
        // revert to song number for currently playing song because user is playing a new song
        currentlyPlayingCell = $('.song-number[data-song-number="' + currentlyPlayingSong + '"]');
        currentlyPlayingCell.html(currentlyPlayingSong);
      }

      if (currentlyPlayingSong !== songNumber) {
        // switch from play to pause to indicate a new song is playing
...
app = angular.module('BlocJams', []);

app.controller('Landing.controller', ['$scope', function($scope) {
